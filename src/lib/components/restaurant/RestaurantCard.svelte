...
<div
	class="restaurant-card relative mb-3 flex h-[248px] w-[300px] cursor-pointer flex-col rounded-2xl bg-white hover:border hover:border-slate-300 hover:shadow-2xl" 
